    ...
    <div className="pb-12">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        <Link
          ...
          className="flex items-center gap-3 rounded-2xl border border-[var(--color-gold-300)] bg-gradient-to-br from-[var(--color-gold-50)] to-white p-5"
        >
          <LayoutGrid className="h-8 w-8 text-[var(--color-gold-600)]" />
          <div>
            <p className="font-bold amharic text-[var(--primary)]">የክፍል ዳሽቦርዶች</p>
            <p className="text-xs amharic text-[var(--foreground)]/60">
              ሰብሳቢ · ፀሐፊ · 10 ክፍሎች — ሙሉ ስራ
            </p>
          </div>
        ...
        <Link
          ...
          className="flex items-center gap-3 rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5"
        >
