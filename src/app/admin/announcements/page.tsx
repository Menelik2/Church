  ...
  return (
    <div>
      ...
      <p className="text-sm text-[var(--foreground)]/60 mt-1 amharic">
        ምስል ያለው ጽሁፍ ይፍጠሩ · አትሙ / ደብቁ · አስተያየቶችን ያጽድቁ
      </p>
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-2">
        ...
        <div>
          <h2 className="font-semibold amharic mb-4">ያሉ ጉዳዮች ({items.length})</h2>
          <ul className="space-y-3">
            ...
            {items.length === 0 && (
              <p className="text-sm text-[var(--foreground)]/50 amharic">ምንም ወቅታዊ ጉዳይ የለም። ከግራ ያክሉ።</p>
            )}
          </ul>
        </div>
      </div>
