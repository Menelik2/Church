...
export const DEPARTMENT_WORKSPACES: DepartmentWorkspace[] = [
  ...
  },
  {
    ...
    is_leadership: false,
    description_am:
      "ተጠሪነቱ ለጸሐፊው ሆኖ የሚከተሉትን ተግባራት ያከናውናል (§10.8)፦\n" +
      "፩. የቤተክርስቲያን ሥርዓትና ደንብ የጠበቁ መዝሙሮች እንዲዘመሩ ማድረግ\n" +
      "፪. በሰ/ት/ቤቱ መደበኛ ፕሮግራም ሳይቆረጥ የመዝሙር አገልግሎት እንዲሰጥ ማድረግ\n" +
      "፫. የተፈቀደ መዝሙሮችን ብቻ ማስጠናትና ማዘመር\n" +
      "፬. አስፈላጊ ሆኖ ሲገኝ ከጽ/ቤቱ ጋር በመነጋገር ወደ ሌሎች ሰ/ት/ቤቶች አገልጋዮች መላክ\n" +
      "፭. የሰርግ እጀባ ግብዣዎች ሲቀርቡ የማጀብ አገልግሎት መስጠት\n" +
      "፮. በጉባኤና ንግስ በዓል የመዝሙር አገልግሎት ማዘጋጀት\n" +
      "፯. ወቅቱን የጠበቁ መዝሙሮች እንዲዘመሩ ክትትል ማድረግ\n" +
      "፰. የልምምድ ቀን መገኘት መቆጣጠር\n" +
      ...
      "፲፬. ለሕፃናት ክፍል አገልግሎት ድጋፍና ክትትል\n" +
      "ንዑሳን፦ መዝሙር አስጠኝ · አቴንዲንስ · ልብስ · የዝማሬ መሳሪያዎች",
  ...
  },
  {
    ...
    is_leadership: false,
    description_am:
      "ተጠሪነት ለም/ሰብሳቢ — ጽሁፍ፣ ድራማ፣ መድረክ በኦርቶዶክስ ስርዓት፣ ስልጠና፣ ሕፃናት ድጋፍ። ንዑስ፡ ጽሁፍ ዝግጅት፣ ሥልጠና፣ መድረክ ዝግጅት፣ ዶክመንቴሽን፣ ቁጥጥር።",
    modules: ["overview", "arts", "tasks", "reports"],
    actions: [
      { label_am: "ዝግጅቶች / ድራማ / ጽሁፍ", href: "/admin/workspace/kine-tibeb?tab=arts", module: "arts" },
      ...
      { label_am: "ክፍል ገጽ", href: "/departments/kine-tibeb", module: "overview" },
    ],
  },
  {
    code: "hisab",
